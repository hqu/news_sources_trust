...
png = os.path.join(H, "figures", "information_flow_map.png")
if os.path.exists(png):
    uri = "data:image/png;base64," + base64.b64encode(open(png, "rb").read()).decode()
    assert 'src="figures/information_flow_map.png"' in out, "flow map img not found"
    out = out.replace('src="figures/information_flow_map.png"', 'src="' + uri + '"')
else:
    print("  WARNING: figures/information_flow_map.png missing, standalone will have a broken image")
